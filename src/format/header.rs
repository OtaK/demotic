use crate::format::parsers::{le_i32_as_u32, take_source_str};
use nom::{
    do_parse,
    tag,
    map,
...
impl crate::Parsable for DemoHeader {
    fn parse(i: &[u8]) -> nom::IResult<&[u8], Self> {
        do_parse!(i,
            tag!(b"HL2DEMO\0")              >>
            demo_protocol: le_i32_as_u32    >>
            network_protocol: le_i32_as_u32 >>
            ...
            ticks: le_i32_as_u32            >>
            frames: le_i32_as_u32           >>
            signon_len: le_i32_as_u32       >>
            (DemoHeader {
                protocol_version: network_protocol.into(),
                demo_protocol, network_protocol,
                server_name, client_name,
                map_name, directory,
                tickrate: (ticks as f32 / playback_time.as_secs_f32()) as u32,
                playback_time,
                ticks, frames,
                signon_len
            })
